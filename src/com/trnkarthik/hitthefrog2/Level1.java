...
public class Level1 extends SimpleBaseGameActivity implements IAccelerationListener, IOnSceneTouchListener {
...
//		final Camera camera = new Camera(0, 0, CAMERA_WIDTH, CAMERA_HEIGHT);
	...
	public Scene onCreateScene() {
	    ...
	    dm = new DataManager(Level1.this);
...
//		this.mPhysicsWorld.registerPhysicsConnector(new PhysicsConnector(FrogSprite, frogbody, true, true));
	...
	public void gameToast(final String msg) {
		this.runOnUiThread(new Runnable() {
			@Override
			public void run() {
				Toast.makeText(Level1.this, msg, Toast.LENGTH_SHORT).show();
			}
		});
	}
